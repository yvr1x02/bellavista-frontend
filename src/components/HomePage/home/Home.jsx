    ...
    <Card className="text-center">
      ...
      <Card.Body className="card-body">
        ...
        <Card.Text className=" card-text mx-5 px-5 p-3">
          <span className="strong-text">"BellaVista casa vacanze"</span> sita in <span className="strong-text">Augusta (Sr)</span>{" "}
          è una villa <span className="strong-text">a 100 metri dal mare</span> interamente ristrutturata nel 2024 ed è
          organizzata per accogliere fino a <span className="strong-text">8 persone.</span> <br /> La struttura di 240mq, con
          meravigliosa <span className="strong-text">vista sul mare e sul monte Etna</span>, è realizzata su due piani.{" "}
